//! Aperçu rapide (cahier des charges, section 6) : une fenêtre transparente et floutée, créée au
//! démarrage puis cachée, qui s'affiche par-dessus tous les logiciels sur l'écran de la souris.
